...
import pickle
import traceback
from llava_server.llava import load_llava, load_phi3
from llava_server.bertscore import load_bertscore, load_sentencetransformer
import numpy as np
import os
...
def create_app():
    ...
    INFERENCE_FN = load_llava(os.environ["LLAVA_PARAMS_PATH"])#load_phi3()#load_llava(os.environ["LLAVA_PARAMS_PATH"])
    BERTSCORE_FN = load_sentencetransformer()
